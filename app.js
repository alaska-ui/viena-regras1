...
function applySite() {
  ...
  $("headerLogo").src = s.logo || "logo-viena.png";
  ...
  $("notice").style.display =
    s.layout?.show_notice === false ? "none" : "flex";

  $("updatesWrap").style.display =
    s.layout?.show_updates === false ? "none" : "block";

  $("searchOpen").style.display =
    s.layout?.show_search === false ? "none" : "block";

  if (
    s.hero_image &&
    s.layout?.show_hero_image !== false
  ) {
    $("heroImage").src = s.hero_image;
  ...
  document.body.insertAdjacentHTML(
    ...
    `
      ...
      >
        ...
        content/rules.json foram enviados.
      </div>
    `
  );
});
